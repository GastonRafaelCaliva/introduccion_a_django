    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fechaDeceso",
                    models.DateField(blank=True, null=True, verbose_name="Fallecido"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nombre",
                    models.CharField(
                        help_text="Ingrese el nombre del género (xej. Programación, BD, SO, etc)",
                        max_length=50,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "resumen",
                    models.TextField(
                        help_text="Ingrese un resumen del libro", max_length=1000
                    ),
                ),
                (
                    "isbn",
                ...
                (
                    ...
                    models.ManyToManyField(
                        help_text="Seleccione un genero (o varios) para el libro",
                        to="catalogo.genero",
                    ),
                ),
            ],
